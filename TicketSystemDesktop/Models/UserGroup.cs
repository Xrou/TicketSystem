...
{
    public class UserGroup : INotifyPropertyChanged, IDbEntity
    {
        private long id;
        private string name;
        ...
        public static UserGroup ParseFromJson(JsonObject parseObject)
        {
        ...
        public static List<UserGroup> ParseArrayFromJson(string response)
        {
            List<UserGroup> parsed = new List<UserGroup>();
